...
| ------------------- | ------- | ---------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------- | --------------- |
| `markdownlint-cli2` | 0.23.2  | 2026-07-27 | Direct dev dependency, resolved by `npm install` while the eslint uplift was in progress. Not chosen for this branch and not needed by it — the lockfile simply moved to the current release. | 2026-08-03, when it passes the 7-day window. Remove the row that day. | Martin 20260802 |
| `minimatch`         | 10.2.6  | 2026-07-27 | Transitive, reached through the markdown and lint tooling. No direct dependency names it, so pinning it back would mean overriding a resolution nothing in this branch asked to change.       | 2026-08-03, when it passes the 7-day window. Remove the row that day. | Martin 20260802 |
| `brace-expansion`   | 2.1.3   | 2026-07-28 | Transitive, reached through the same tooling as `minimatch`. Same reasoning: no direct dependency names it.                                                                                   | 2026-08-04, when it passes the 7-day window. Remove the row that day. | Martin 20260802 |
