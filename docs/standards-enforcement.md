...
| Prose structure                              | `.markdownlint.jsonc` / `.markdownlint-cli2.jsonc`, gate 2 (via lint-staged)                                                                                                 |
...
| Link and anchor integrity                    | `scripts/check-links.mjs`, gate 2 check 17, gate 7                                                                                                                           |
