...
| Dependency licence, block      | Anything outside the allow list for that scope            | Resolved dependencies, direct and transitive          |
| Runtime licence allow list     | Permissive licences only                                  | Dependencies present in what is shipped               |
| Development licence allow list | Permissive and weak-copyleft                              | Build, test and tooling dependencies only             |
