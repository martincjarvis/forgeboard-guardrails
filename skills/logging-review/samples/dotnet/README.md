...
This is an **illustrative** corpus for the `logging-review` skill — source the skill reviews against, **not** built or tested by this repository. It is the durable regression set the skill reviews against. None of these files are wired into any buildable project or test run.
