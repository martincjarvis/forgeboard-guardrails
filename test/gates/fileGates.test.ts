...
// mkdtemp prefix, not prose
// cspell:ignore filegates
...
test(
  "formats in place and resolves on clean content",
...
test(
  "throws a GateFailure naming the gate when a built-in rejects",
  { skip: skipWithoutSemgrep },
  async () => {
    const dir = scratch();
