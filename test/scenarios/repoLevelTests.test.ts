...
test(
  "a failing repo-level architectureTest rejects regardless of which component changed",
  { skip: skipWithoutSemgrep },
  async () => {
    const fixture = scaffoldFixtureRepo({ statusContractEnabled: false });
    execFileSync("git", ["checkout", "-b", "feature/FB-0005-x"], {
      cwd: fixture.dir,
    });
    writeFileSync(
      join(fixture.dir, "tests", "architecture.js"),
      "process.exit(1);\n",
    );
    writeFileSync(
